...
class TestOllamaProvider:
    ...
    def test_pull_model(self, mock_pull):
        ...
        # Mock streaming response
        mock_pull.return_value = [{"status": "downloading", "completed": 100, "total": 1000}, {"status": "success"}]
...
class TestWatsonxProvider:
    ...
    def test_initialization_with_credentials(self):
        ...
        with patch.dict(
            "sys.modules",
            {"ibm_watsonx_ai": mock_ibm_module, "ibm_watsonx_ai.foundation_models": mock_foundation_models},
        ):
            with patch.dict(
                os.environ,
